...
import { IAudioTrackData } from "../../src/types/audioTrack";
import { getUrlParam } from "../../src/utils";
import { IDecoratedAsset, IMixParams } from "../../src/types";

// Mock dependencies
const mockClient = {
  triggerOnPlayAssets: jest.fn(), // Add the mocked function here
...
const mockListenerPoint = {} as Feature<Point>;
...
const mockDecoratedAsset = {
  ...
  locationPoint: {} as Feature<Point>,
  playCount: 0,
...
describe("Playlist", () => {
  ...
  test("updateParams should update listenerPoint and listenTagIds", () => {
    const newParams: IMixParams = {
      listenerPoint: {} as Feature<Point>,
      listenTagIds: [1, 2],
    };
