...
export const MOCK_ASSET_DATA = [
  ...
  },
  {
    id: 11932,
    description:
      "Hotel, De Bonte, oss,Roeselae, Sint Hubrechtsstraat, Roeselae",
    latitude: 50.948419,
    longitude: 3.131971,
    shape: null,
  ...
  },
  {
    ...
    updated: "2021-08-02T05:32:10.049460",
    weight: 50,
    start_time: 0.0,
    end_time: 61.279,
    user: {
...
export const MOCK_TIMED_ASSET_DATA = [{"id":854,"start":30.0,"end":120.0,"asset_id":13035,"project_id":10}]